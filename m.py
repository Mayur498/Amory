...
bot = telebot.TeleBot('7110846889:AAEhkLgAbh-tmicDhyeCFS1XSrufcMMBcWg')
...
    
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: Bought from @black_devilyt"
    bot.reply_to(message, response)
...
                response = "You Are On Cooldown ❌. Please Wait 1 second from latest attack"
                bot.reply_to(message, response)
                return
